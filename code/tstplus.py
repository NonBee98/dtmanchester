...
__all__ = ['PositionalEncoding', 'SinCosPosEncoding', 'Coord2dPosEncoding', 'Coord1dPosEncoding',
           'ScaledDotProductAttention', 'MultiHeadAttention', 'newTSTPlus', 'MultiTSTPlus']
...
def create_head(nf, c_out, seq_len):
    nf *= seq_len
    layers = [Flatten()]
...
class newTSTPlus(nn.Sequential):
    ...
    def __init__(self, c_in:int, c_out:int, seq_len:int, max_seq_len:Optional[int]=512,
        ...
        head = nn.Sequential(nn.Dropout(0.1), nn.Conv1d(self.head_nf, 1, 1))
